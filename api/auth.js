...
export default function handler(req, res) {
  ...
  const redirectUrl = `https://renz2451.github.io/telegram-login/?id=${id}&first_name=${encodeURIComponent(first_name)}&last_name=${encodeURIComponent(last_name || '')}&username=${username}&photo_url=${encodeURIComponent(photo_url || '')}`;
